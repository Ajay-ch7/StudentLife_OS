...
class CalendarEvent(TimestampMixin, Base):
    ...
    creation_notified: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    reminded_day_before: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
